...
List<TenantModel> getTenantsCard() {
  List<TenantModel> tenantCards = [
    TenantModel(Color(0xFFff415f), 'Paul', "Property 123", 'assets/images/myAvatar.png', 0,
        false),
    TenantModel(Color(0xFFff415f), 'James', "Property 321", 'assets/images/myAvatar.png', 1,
        true)
  ];
