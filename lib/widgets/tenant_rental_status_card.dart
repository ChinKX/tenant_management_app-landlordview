...
class TenantRentalStatusCardWidget extends StatefulWidget {
  final TenantModel tenant;

  const TenantRentalStatusCardWidget({Key key, this.tenant}) : super(key: key);

  @override
  State<StatefulWidget> createState() => TenantRentalStatusCardWidgetState();
}

class TenantRentalStatusCardWidgetState extends State<TenantRentalStatusCardWidget> {
  @override
